...
CapDo = 10 --§¨ng nhËp lÇn ®Çu khi t¹o nh©n vËt tù ®éng lªn cÊp theo chØ ®Þnh
--============================================================================================================--
--													Ho¹t §éng												  --
--============================================================================================================--
...
-------NPC Phong L¨ng §é-------------
PhongLangDo = 1
SoLanDiThuyenPLDTrongNgay = 2
ThoiGianBaoDanhPLD = 5 --phut
ThoiGianDiThuyenPLD = 15 --phut

NPCVoLamLienDau = 0
LoanChienCuuChauCoc = 0 --TÞa NPC Ch­ëng §¨ng Cung N÷
HoatDongDauNguu = 0 --TÞa NPC Ch­ëng §¨ng Cung N÷
...
------Tèng Kim----------------
ThamGiaTongKim = 1
SoLanThamGiaTongKimTrongNgay = 3
ThoiGianOpenTK ={0100, 0300, 0500, 0700, 0900, 1100, 1300, 1500, 1700, 1900, 2100, 2300}
ThoiGianBaoDanhTK = 2 --phut
ThoiGianChienDauTK = 45 --phut
KiemTraIpChongBoostDiemTongKim = 1
KhongCoNguoiDanhLenDiemTongKim = 1
VongSangTopTongKim9h = 0
ThuongTopTongKimTuDong9h = 0
SoDiemToiDaMoiTran = 100000 --Sè ®iÓm t«i ®a mçi trÇn
------ThÊt Thµnh §¹i ChiÕn ---------
ThatThanhDaiChien = 0
...
BanItemHoTro = 0 -- NPC b¸n c¸c vËt phÈm hæ trî nh­ Thuèc lag Tèng Kim,..
