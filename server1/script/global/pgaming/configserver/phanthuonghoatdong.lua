...
if nRuong < SoLuongRuongTrongNhanThuong then
		...
		return 1
			...
			tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4903,1,0,0}, nCount = 5}, "test", 1);
end
--Ph«n th≠Îng k’t thÛc Phong L®ng ßÈ bæng l÷nh bµi phong l®ng ÆÈ
TAB_LBPLD = {
			{szName="<color=pink>V‚ L©m L÷nh", tbProp={6,1,4903,1,0,0}, nCount = 2},
		}
...
tbVnNewItemDropBossAward = {
	{{szName="Ho‡ng Kim L?nh",tbProp={4,2059,0,0,0,0}, nCount = 1},},
