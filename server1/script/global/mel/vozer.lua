...
dofile("script/global/mel/vozer.lua")
	local tbOpt = {
		...
		{"§æi T¬ Lôa Hoµng Kim",DoiPhiPhongHoangKim},
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>     Tû lÖ ®æi 6000 Phong Háa lÖnh = Khu«n ®óc TuyÖt §Ønh Giíi ChØ<enter>",11,
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	if nPhongHoaLenh > 6000 then
		ItemIndex = AddItem(4,2053,0,0,0,0)
		SyncItem(ItemIndex); 
		ConsumeEquiproomItem(6000,6,1,4926,-1)
	else
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>     Tû lÖ ®æi 6000 Phong Háa lÖnh = Phi Phong Hoµng Kim<enter>",11,
...
function DoiNhatKy()
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>     Tû lÖ ®æi 3000 Phong Háa lÖnh = NhÊt Kû Cµn Kh«n Phï<enter>",11,
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>     Tû lÖ ®æi 500 Phong Háa lÖnh = 1 §¹i Thµnh BÝ KÝp 120<enter>",11,
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	if nPhongHoaLenh > 500 then
		ItemIndex = AddItem(6,1,2425,1,0,0)
		SyncItem(ItemIndex); 
		ConsumeEquiproomItem(500,6,1,4926,-1)
	else
		Talk(1,"","B¹n vÉn ch­a ®ñ Phong Háa lÖnh, h·y cè g¾ng thu thËp thªm")
		return 1
	end
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>     Tû lÖ ®æi 100 Phong Háa lÖnh = 1 Trang BÞ §éng S¸t<enter>",11,
...
function ngocboids()
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>      Tû lÖ ®æi 100 Phong Háa lÖnh = 1 Trang BÞ §éng S¸t",11,
	"Ta ®ång ý/ngocboids2",
	"Ta sÏ quay l¹i sau!/no"
	);
end
...
function DoiHHLC()
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	Describe("Sè l­îng Phong Háa lÖnh hiÖn cã: <color=yellow>: "..nPhongHoaLenh.."<color><enter>     Tû lÖ ®æi 20000 Phong Háa lÖnh = 1 H·n HuyÕt Long C©u<enter>",11,
...
local nPhongHoaLenh = CalcEquiproomItemCount(6,1,4926,-1);
	if nPhongHoaLenh > 20000 then
		ItemIndex = AddItem(0,10,18,10,0,0,0)
		SyncItem(ItemIndex); 
		ConsumeEquiproomItem(20000,6,1,4926,-1)
	else
		Talk(1,"","B¹n vÉn ch­a ®ñ Phong Háa lÖnh, h·y cè g¾ng thu thËp thªm")
		return 1
	end
