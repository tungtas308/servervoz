...
Include("\\script\\global\\mel\\feature\\areatrain\\join.lua")
Include("\\script\\global\\mel\\feature\\taskdaily\\head.lua")
...
function main(nItemIndex)
	...
	--dofile("script/global/mel/feature/areatrain/head.lua")
	--dofile("script/global/mel/feature/areatrain/join.lua")
	...
	local tbSay = {format(TITLEDIALOG, GetName(), GetAccount(),day,mm,year,hour,mmin ,nW,nX,nY)};
		...
		--tinsert(tbSay,"B¹n cã muèn massage kh«ng ?/#pFeatureArea:gotoRoom()")
		tinsert(tbSay, "NhËn th­ëng nhiÖm vô Daily/#Task_Daily:main()")
