...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function HKMPRac()
	GiveItemUI( "§æi R­¬ng Hoµng Kim", "B¹n cÇn chuÈn bÞ 5 mãn Trang BÞ HKMP vµ 5 tiÒn ®ång trong hµnh trang th× cã thÓ ®æi ®­îc 10 LÖnh bµi gäi Boss Hoµng Kim", "HKMPRac_1", "onCancel",1 );
end
...
function HKMPRac_1( nCount )
	...
	if nCount ~= 5 then						
		...
		if (CalcEquiproomItemCount(4, 417, 1, 1)>=5) then
			...
			AddStackItem (10,6,1,4916,1,0,0)
