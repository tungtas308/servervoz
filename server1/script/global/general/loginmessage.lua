...
function LoginMessage()
	...
	--tbAwardTemplet:GiveAwardByList({tbProp = {0,214}, nCount=1, nQuality=1, nBindState=-2}, "Vinh DiÖu", 1);
	--tbAwardTemplet:GiveAwardByList({tbProp = {0,215}, nCount=1, nQuality=1, nBindState=-2}, "Vinh DiÖu", 1);
	--tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4924,0,0,0}, nCount=1, nBindState=-2}, "§éng S¸t", 1);
